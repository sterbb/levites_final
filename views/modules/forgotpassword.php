                     ...
                     <form class="row g-3">
                        ...
                        <div class="col-12">
                           <div class="d-grid gap-2">
                              ...
                              <a href="requestPassword"  type="button"  class="btn text-white"  style="background: radial-gradient(circle, rgba(192,128,249,1) 0%, rgba(148,191,242,1) 100%); font-weight:bold;">Send</a>
