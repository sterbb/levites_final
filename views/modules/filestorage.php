...
<header class="top-header">
    ...
    <main class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">File Storage</div>
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
              </li>
              <li class="breadcrumb-item active" aria-current="page">Church Storage</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
        ...
        <div class="col-12 col-lg-3">
          <div class="card overflow-hidden">
            <div class="card-body">
              ...
              <h5 class="mt-3 mb-0">My Drive</h5>
            </div>
            <div class="fm-menu">
              <div class="list-group list-group-flush">
                <a href="javascript:;" class="list-group-item py-1 border-top"><i class="bx bx-folder me-2"></i><span>All Files</span></a>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="mb-0 text-primary font-weight-bold">Affiliates</h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-2">
                  <h6 class="mb-0">San Sebastian Cathedral (Bacolod)</h6>
              ...
              <div class="d-flex align-items-center mt-3">
                ...
                <div class="flex-grow-1 ms-2">
                  <h6 class="mb-0">Abad Church (Bacolod)</h6>
              ...
              <div class="d-flex align-items-center mt-3">
                ...
                <div class="flex-grow-1 ms-2">
                  <h6 class="mb-0">Our Lady Of Lourdes Parish Church</h6>
              ...
              <div class="d-flex align-items-center mt-3">
                ...
                <div class="flex-grow-1 ms-2">
                  <h6 class="mb-0">Carmelites Bacolod</h6>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="font-weight-bold text-danger">Prayer of Intention</div>
                        </div>
                      </td>
                      <td>Only you</td>
                      <td>April 3, 2023</td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="font-weight-bold text-primary">Sunday Mass</div>
                        </div>
                      </td>
                      <td>3 members</td>
                      <td>April 9, 2023 </td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="font-weight-bold text-primary">Worship Event</div>
                        </div>
                      </td>
                      <td>10 members</td>
                      <td>Jul 17, 2023</td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="font-weight-bold text-success">Retreat</div>
                        </div>
                      </td>
                      <td>7 members</td>
                      <td>Sep 8, 2023</td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="font-weight-bold text-primary">Outreach Program</div>
                        </div>
                      </td>
                      <td>3 members</td>
                      <td>Jun 12, 2023</td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="font-weight-bold text-primary">San Sebastian/Lupit</div>
                        </div>
                      </td>
                      <td>10 members</td>
                      <td>Jul 17, 2023</td>
