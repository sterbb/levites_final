                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="user-groups ms-auto">
                          <img src="views/assets/images/avatars/01.png" width="35" height="35" class="rounded-circle" alt="">
                          <img src="views/assets/images/avatars/02.png" width="35" height="35" class="rounded-circle" alt="">
                        </div>
                  ...
                  <div class="card shadow-none border radius-15">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="user-groups ms-auto">
                          <img src="views/assets/images/avatars/04.png" width="35" height="35" class="rounded-circle" alt="">
                        </div>
                      </div>
                  ...
                  <div class="card shadow-none border radius-15">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="user-groups ms-auto">
                          <img src="views/assets/images/avatars/07.png" width="35" height="35" class="rounded-circle" alt="">
                          <img src="views/assets/images/avatars/08.png" width="35" height="35" class="rounded-circle" alt="">
                        </div>
                      </div>
