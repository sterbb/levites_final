...
<main class="page-content">
      ...
      <div class="">
        <h4><i class="fa-solid fa-users me-2"></i> Sub-users </h4>
        <div class="row row-cols-4 overflow-auto border border-2 border-solid border-primary p-3" style= "height:150px;">
          ...
          <?php
            ...
            if (!empty($users) && isset($users[0]) && !empty($manual) && isset($manual[0])) {
                        ...
                        <div class="card-body">
                          <div class="d-flex align-items-center ">
                            ...
                            <div class="">';
                              ...
                              echo '<h4 class="mb-0 text-primary">' . $manualUser['fname'] . '</h4>
                            </div>
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <h6 class="mb-0 text-uppercase mt-2">Account Access  </h6>
                  ...
                  <div class="row mt-5">
										...
										<div class="col-sm-9">
											<div class="d-md-flex d-grid align-items-center justify-content-end  gap-3">
                        <button type="reset" class="btn btn-outline-danger px-4 clear_accounts_field">Clear</button>
