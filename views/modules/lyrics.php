...
<br><br><br>
    ...
    <div class="row g-0">
        ...
        <div class="lyrics">
        <h2 ><a href="" class="text-dark"><b>Phil Wickham Lyrics</b></a></h2>
                    ...
                    <div class="card mt-3 ">
                        <div class="card-body">
                            <div class="video-container ">
                                <iframe width="600" height="300" class="rounded-3 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " src="https://www.youtube.com/embed/OjXkeHHPTzQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen> </iframe>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col" >
                  ...
                  <div class="modal fade" id="EditPlaylist" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-body">                                       
                            <div class="row">
                                <div class="col-12"> 
                                    ...
                                    <input type="text" class="form-control" id="NameInput" placeholder="Enter Playlist Name">
                                </div>
                            </div>                       
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-warning" id="saveButtonNameBtn" >Save</button>
                    </div>
                    </div>
                </div>
                </div>
