                    ...
                    <div class="card w-100 mx-10 mb-0">
                        <div class="card-header bg-transparent">
                            <div class="d-flex align-items-center py-2 px-2">
                                <div class="px-2">
                                    <h6 class="mb-0 fw-bold"> <i class="fadeIn animated bx bx-church text-5"></i>Request Collaboration</h6>
                                </div>
                                <!-- MARGIN RIGHT -->
                ...
                <div class="col-12 col-lg-12 col-xl-12 d-flex ">
                    <div class="card w-100 mx-10 mb-0">
                        <div class="card-header bg-transparent">
                            <div class="d-flex align-items-center py-2 px-2">
                                <div class="px-2">
                                    <h6 class="mb-0 fw-bold"> <i class="fadeIn animated bx bx-church text-5"></i>Church Collaboration</h6>
                                </div>
                                <!-- MARGIN RIGHT -->
                                <div class="ms-auto me-2">
