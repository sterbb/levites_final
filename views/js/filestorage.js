                    ...
                    <div class="card radius-10 border-0 border-bottom border-primary border-4 shadow-sm" >
                      <div class="card-body " id="public_folder" data-bs-target="#folderModal" >
                        <div class="d-flex align-items-center">
                          ...
                          <button type="button" id="" class="pinned-button cursor-pointer position-absolute top-0 start-0 clicked" data-bs-toggle="dropdown"><i class="bx bx-pin fs-4 "></i>
                        ...
                        <h5 class="mt-3 mb-0 cursor-pointer custom-tooltip"  data-bs-toggle="modal" data-delay="2000" data-bs-target="#folderModal"  data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="" data-bs-html="true" >${folderName} </i></h5>
                        </p>
                      </div>
                    </div>
                `;
...
function setUpFilePathEdit(element){
  ...
  $('#noteField').val('');
  // $("#addNoteButton").removeAttr("hidden");
  // $("#addNoteButton").attr("id", "editNoteButton");
