...
$("#updatePublic").submit(function (e) {
    ...
    var public_confirm_password = $("#pub_conpassword").val(); // New field
    ...
    if (
      ...
      public_confirm_password.trim() === "" || // Check the new field
      public_email.trim() === "" ||
      public_fname.trim() === "" ||
      public_lname.trim() === "" ||
    ...
    } else if (public_password !== public_confirm_password) { // Check if passwords don't match
      Swal.fire({
        icon: "error",
        title: "Error",
